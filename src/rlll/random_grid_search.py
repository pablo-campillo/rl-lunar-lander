...
def queue_random_grid_search_experiments(num_exps, seed):
    ...
    for _ in range(num_exps):
        params = {
            ...
            "rand_min_epsilon": round(random.uniform(0.020, 0.001), 3),
            "rand_gamma": round(random.uniform(0.95, 0.999), 3),
            ...
            "rand_stack_size": random.choice([1, 2, 3]),
        ...
        subprocess.run(["dvc", "exp", "run", "--queue",
                        ...
                        "--set-param", f"train.min_epsilon={params['rand_min_epsilon']}",
